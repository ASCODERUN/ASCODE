...
import * as IDL from './idl/hexuma_ai.json'; // Adjust path to your generated IDL file
...
class HexumaAI {
  ...
  async initialize(): Promise<void> {
    try {
      ...
      throw new Error('Failed to initialize Ontora AI client');
    }
  }
